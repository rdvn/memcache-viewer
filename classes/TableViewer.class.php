...
class TableViewer {
	...
	public static function getTableHTML($cache){
		...
		$output = '<table id="TableViewer"><tr><th>Key</th><th>Slab</th><th>Size</th><th>Value</th><th>Expiration Time</th><th>Expires In</th><th>Delete</th></tr>';
		...
		foreach ($cache->items as $item){
			...
			$output .= '<td class="value">' . $item->getValue() . '</td>';
